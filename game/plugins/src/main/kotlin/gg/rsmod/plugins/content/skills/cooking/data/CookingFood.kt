...
enum class CookingFood(val raw_item: Int, val cooked_item: Int, val burnt_item: Int, val xp: Double, val minLevel: Int, val maxLevel: Int, val requireRange: Boolean = true) {
    ...
    BEAR_MEAT(Items.RAW_BEAR_MEAT, Items.COOKED_MEAT, Items.BURNT_MEAT, 30.0, 1, 31, false),
    ...
    PLAIN_PIZZA(Items.UNCOOKED_PIZZA, Items.PLAIN_PIZZA, Items.BURNT_PIZZA, 143.00, 35, 99, true),
    CAKE(Items.UNCOOKED_CAKE, Items.CAKE, Items.BURNT_CAKE, 180.0, 40, 99, true),
    REDBERRY_PIE(Items.UNCOOKED_BERRY_PIE, Items.REDBERRY_PIE, Items.BURNT_PIE, 78.0, 10, 99, true),
    MEAT_PIE(Items.UNCOOKED_MEAT_PIE, Items.MEAT_PIE, Items.BURNT_PIE, 110.0, 20, 99, true),
    APPLE_PIE(Items.UNCOOKED_APPLE_PIE, Items.APPLE_PIE, Items.BURNT_PIE, 130.0, 30, 99, true),
