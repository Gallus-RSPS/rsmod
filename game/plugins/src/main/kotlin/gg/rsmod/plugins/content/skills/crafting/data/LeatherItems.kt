...
enum class LeatherItem(val id: Int, val level: Int, val leatherCount: Int, val amount: Int = 1, val ticks: Int = 4, val craftXp: Double) {
    ...
    XERICIAN_HAT(id = Items.XERICIAN_HAT, leatherCount = 3, level = 14, craftXp = 66.0),
    XERICIAN_ROBE(id = Items.XERICIAN_ROBE, leatherCount = 4, level = 17, craftXp = 88.0),
    XERICIAN_TOP(id = Items.XERICIAN_TOP, leatherCount = 5, level = 22, craftXp = 110.0);
}