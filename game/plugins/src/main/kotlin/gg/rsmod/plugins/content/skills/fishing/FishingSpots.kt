...
val feather_type = setOf(
    Items.FEATHER, Items.STRIPY_FEATHER
)
...
enum class FishingSpots(val spotEntityId: Int, val option: String, val toolId: Int, val baitId: Int, val animation: Int, vararg fish: Fish) {
    ...
    LURE2(Npcs.ROD_FISHING_SPOT_1526, "lure", Items.FLY_FISHING_ROD, Items.FEATHER, 622, Fish.TROUT, Fish.SALMON),
